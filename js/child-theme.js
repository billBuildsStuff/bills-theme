...
(function (global, factory) {
	...
	*/
	...
	var $j = jQuery.noConflict(); // Remove the # from the hash, as different browsers may or may not include it

	$j(document).ready(function () {
	  // get the anchor link buttons
	  const menuBtn = $j('.nav-link'); // when each button is clicked
	...
	$j('#menu-item-93').click(function () {
	  // #menu-item-93 for local #menu-item-85 for production
	...
	$j('#menu-item-30').click(function () {
	  // #menu-item-52 for local #menu-item-30 for production
	  $j('#about_me').show();
	  setTimeout(function () {
	    $j('#about_me').hide(800);
	  }, 15000);
